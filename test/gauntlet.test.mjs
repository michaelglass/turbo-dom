...
// Run @testing-library/dom UNMODIFIED against the turbodom environment. This is
...
test('RTL getByText / queryByText against turbodom', () => {
...
test('RTL event bubbling through turbodom tree (delegation)', () => {
